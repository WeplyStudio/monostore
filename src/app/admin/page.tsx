...
export default function AdminPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-[#F8F9FA]">
      {/* Sidebar Navigasi */}
      <aside className="w-full md:w-72 bg-white border-r border-slate-200 md:sticky md:top-0 md:h-screen flex flex-col z-40">
      ...
      <main className="flex-1 p-6 md:p-10 overflow-x-hidden">
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          {/* Section: Vouchers */}
          {activeSection === 'vouchers' && ( activeSection === 'vouchers' && (
            <div className="space-y-6 animate-fadeIn">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
